...
def main():
    ...
    for f, r in zip(f_files, r_files):
        ...
        -phred33 {0} {1} {2} {3} unpaired_unaligned_1.fq.gz unpaired_unaligned_2.fq.gz \
        ILLUMINACLIP:{4}:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36".format(f, r,
                                                                                           out_f, out_r,
                                                                                           adaptors, threads)
        run(cmd, shell=True)
